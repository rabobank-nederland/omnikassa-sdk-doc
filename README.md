...
- [Introduction](#introduction)
  ...
  * [User-Agent and partnerReference](#User-Agent-and-partnerReference)
...
- User-Agent: The userAgent field is filled with the name and version of your application. It should adhere to the standard described [here](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent).
...
|                                 |                                                                                                                       | if a shopperBankstatementReference is added:<br/> - May consist of all ASCII characters<br/>- This field is shortened to a maximum of 255 characters.                                                                                                                                            |
|                                 |                                                                                                                       | if a shopperBankstatementReference is not added:<br/> - May consist only of alphanumeric characters<br/>- This field is shortened to a maximum of 24 characters.                                                                                                                                 |
...
|                                 |                                                                                                                       | Optional, setting `enableCardOnFile` to `true` will allow customers to save cards at rabo smart pay.                                                                                                                                                                                             |
...
| `shopperRef`                    | This is the reference of the customer at merchant webshop, should be a unique value at merchant webshop                 | Optional                                                                                                                                                                                                                                                                                         |
